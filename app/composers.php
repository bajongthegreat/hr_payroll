...
View::composer(['employees.medical_examination.partials.single_add', 'employees.medical_examination.partials.bulk_add','employees.medical_examination.partials.bulk_edit', 'employees.medical_examination.partials.single_edit'], 'Acme\Composers\MedicalExaminationsComposer@medical_establishments');
View::composer(['employees.medical_examination.partials.single_add', 'employees.medical_examination.partials.single_edit'], 'Acme\Composers\MedicalExaminationsComposer@medical_findings');
View::composer(['employees.medical_examination.partials.single_add', 'employees.medical_examination.partials.single_edit'], 'Acme\Composers\MedicalExaminationsComposer@recommendations');
...
View::composer(['employees.partial.violations', 'disciplinary_actions.index'], 'Acme\Composers\ViolationComposer@ViolationsOffenseObject');
