		...
		@endif
				<div class="form-group">
					...
					<div class="col-sm-4">
					 ...
					 {{Form::hidden('employee_work_id', $work_id )}}
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						{{ Form::select('medical_establishment',$medical_establishments, $pe->medical_establishment_id, array('class' => 'form-control', 'required') ) }}
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						{{ Form::select('medical_findings', $medical_findings , $pe->medical_findings_id, array('class' => 'form-control', 'required') ) }}
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						{{ Form::select('recommendation',$recommendations ,$pe->recommendations, array('class' => 'form-control', 'required') ) }}
					</div>
