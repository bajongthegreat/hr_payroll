...
<h1>Edit Company  <a  href="{{ action('CompaniesController@index') }}" class="btn btn-default "><span class="glyphicon glyphicon-chevron-left"></span >  Go Back</a>
</h1>
</div>
...
<div class="container">
	...
	{{ Form::model($company, ['action' => ['CompaniesController@update', $company->id], 'class' => 'form-horizontal', 'method' => 'PATCH', 'role' => 'form']) }}
