...
<h1>Add Rates  <a  href="{{ action('RatesController@index') }}" class="btn btn-default "><span class="glyphicon glyphicon-chevron-left"></span >  Go Back</a>
</h1>
</div>
	...
	<div class="container">
		...
		{{Form::open(['action' => 'RatesController@store', 'class' => 'form-horizontal', 'role' => 'form'])}}
